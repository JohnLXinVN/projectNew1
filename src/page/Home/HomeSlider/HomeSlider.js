                        ...
                        <div className="col-7">
                            <div className={cx('wrapper-slider')}>
                                ...
                                <div className={cx('description')}>
                                    ...
                                    efficiency, and accelerate business expansion. Join the finance teams, in 32
                                    countries, that trust us with a single global solution.
                                </div>
